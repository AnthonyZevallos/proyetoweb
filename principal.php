 ...
 <div class="modal-content">
      <div class="modal-header">
       ...
       <div class="modal-body">
         ...
         <ul>
             <b>nombre</b><li id="nombrep"></li>
             <b>apellidos</b><li id="apellidop"></li>
             <b>teléfono</b><li id="telefono"></li>
             <b>lugar de procedencia</b><li id="pais"></li>
             <b>email</b><li id="email"></li>
         </ul>      
